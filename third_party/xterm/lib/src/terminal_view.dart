...
class TerminalView extends StatefulWidget {
  ...
  /// [TextInputType.text] by default (a normal keyboard with suggestions,
  /// autocorrect and voice dictation enabled).
  final TextInputType keyboardType;

  /// Called when the soft keyboard inserts rich content (e.g. pasting an image
  /// via Gboard's inline "insert content" mechanism). When non-null the text
  /// input advertises support for image mime types. Null disables the feature.
