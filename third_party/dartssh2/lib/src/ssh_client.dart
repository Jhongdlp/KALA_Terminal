...
class SSHClient {
  ...
  /// KAMMEL patch: host key verification with the raw key blob, so the caller
  /// can compute a SHA256 fingerprint. Wins over [onVerifyHostKey].
  ...
  SSHClient(
    ...
    _transport = SSHTransport(
      ...
      onVerifyHostkeyBlob: onVerifyHostkeyBlob,
